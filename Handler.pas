...
procedure BoxSet2(AComboBox : TComboBox);
type
  THandler = class
  ...
  begin
    for i := 0 to (AComboBox.Count - 1) do
      begin
      	...
      	AComboBox.ListItems[i].Font.Size      := 19; // changing the properties...
...
begin
  ...
  begin
    for i := 0 to (AComboBox.Count - 1) do
      begin
      	AComboBox.ListItems[i].StyledSettings := []; // remove parent styles...
      	AComboBox.ListItems[i].Font.Size      := 18; // changing the properties...
        AComboBox.ListItems[i].Font.Style     := [TFontStyle.fsBold];
        AComboBox.ListItems[i].FontColor      := TAlphaColorRec.Black;
        AComboBox.ListItems[i].TextAlign      := TTextAlign.Leading;
      end;
  end;
end;
